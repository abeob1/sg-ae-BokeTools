...
Namespace AddOnInstaller
    ...
    Public Class AddOnInstallInfo
        ...
        Public Sub New()
            MyBase.New
            'INITIALIZATION CODE	...
            AddOnName = "AE_BokeTools_IN01"
            PartnerName = "Abeo"
            RestartNeeded = False
            ExeFile = "AE_BookTools_AV01.exe"
            ExtraFiles = New String() {"AE_BookTools_AV01.pdb", "AE_LOADREPAIRNOTES.txt", "Repair Notes.srf", "Tools Category Selection.srf"}
