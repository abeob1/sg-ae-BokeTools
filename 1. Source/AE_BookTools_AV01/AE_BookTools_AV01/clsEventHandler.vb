...
Public Class clsEventHandler
            ...
            If pVal.BeforeAction = False Then
                Select Case pVal.MenuUID
                    Case "1288", "1289", "1290", "1291"
                        If p_oSBOApplication.Forms.ActiveForm.TypeEx = "149" Then
                            'BP_SBO_MenuEvent(pVal, BubbleEvent)
                        End If
                    Case "1292"
                        If p_oSBOApplication.Forms.ActiveForm.TypeEx = "REPR" Then
                            RepairNotes_SBO_Appln_MenuEvent(pVal, BubbleEvent)
                        End If
                End Select
            End If
            ...
            Select Case pVal.FormTypeEx
                Case "149"
                    If Not (pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_UNLOAD Or pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_CLOSE) Then
                        ...
                        SalesQuote_SBO_ItemEvent(FormUID, pVal, BubbleEvent, oForm)
                        Exit Sub
                    End If
                Case "133"
                    If Not (pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_UNLOAD Or pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_CLOSE) Then
                        oForm = p_oSBOApplication.Forms.GetForm(pVal.FormType, pVal.FormTypeCount)
                        SalesInvoice_SBO_ItemEvent(FormUID, pVal, BubbleEvent, oForm)
                        Exit Sub
                    End If
                Case "TCS"
                    If Not (pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_UNLOAD Or pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_CLOSE) Then
                        oForm = p_oSBOApplication.Forms.GetForm(pVal.FormType, pVal.FormTypeCount)
                        ToolsCate_SBO_ItemEvent(FormUID, pVal, BubbleEvent, oForm)
                        Exit Sub
                    End If
                Case "REPR"
                    If Not (pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_UNLOAD Or pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_CLOSE) Then
                        oForm = p_oSBOApplication.Forms.GetForm(pVal.FormType, pVal.FormTypeCount)
                        RepairNotes_SBO_ItemEvent(FormUID, pVal, BubbleEvent, oForm)
                        Exit Sub
                    End If
            End Select
    ...
    Sub AddMenuItems()
        ...
        'LoadFromXML(".xml", SBO_Application)
